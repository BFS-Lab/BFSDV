...
route:/cdsms/admin/packages/manage_user.php?id=1
...
![image-20240725204928360](assets/image-20240725204928360.png)
...
```
GET /cdsms/admin/?page=user/manage_user&id=5 HTTP/1.1
Host: localhost
...
![image-20240725210445064](assets/image-20240725210445064.png)
