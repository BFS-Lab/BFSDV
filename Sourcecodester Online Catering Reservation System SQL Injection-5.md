...
route:/cdsms/classes/Users.php?f=delete

related code file:User.php

injection parameter:${'id'}

#### 1.Vulnerability analysis

After receiving the id parameter passed in through the get method in the User.php file, it is directly spliced into the SQL query statement for execution without any security filtering. An attacker can use this parameter to perform SQL injection to read arbitrary database information.

![image-20240725212437091](assets/image-20240725212437091.png)
...
```
POST /cdsms/classes/Users.php?f=delete HTTP/1.1
Host: localhost
Content-Length: 4
...
Referer: http://localhost/cdsms/admin/?page=user/list
...
![image-20240725212541113](assets/image-20240725212541113.png)
